...
namespace UsbRelayNet.Win32 {
    ...
    public static class Kernel32 {
        ...
        ///     The most commonly used I/O devices are as follows: file, file stream, directory, physical disk, volume, console
        ...
        ///     <br />
        ///     See
        ///     <see href="https://docs.microsoft.com/en-us/windows/win32/api/fileapi/nf-fileapi-createfilew">CreateFileW function</see>
        ///     .
        /// </summary>
        /// <param name="strName">
        ...
        /// </param>
        /// <param name="lpSecurity">
        ///     A pointer to a
        ///     <see href="https://docs.microsoft.com/previous-versions/windows/desktop/legacy/aa379560(v=vs.85)">SECURITY_ATTRIBUTES</see>
        ///     structure that contains two separate but related data members: an optional security descriptor, and a Boolean value
