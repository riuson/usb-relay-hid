...
namespace UsbRelayNet.Win32 {
    ...
    public static class SetupApi {
        ...
        ///     <br />
        ///     See
        ///     <see href="https://docs.microsoft.com/en-us/windows/win32/api/setupapi/ns-setupapi-sp_device_interface_data">
        ...
        ///     <br />
        ///     See
        ///     <see href="https://docs.microsoft.com/en-us/windows/win32/api/setupapi/ns-setupapi-sp_devinfo_data">
        ///         SP_DEVINFO_DATA
        ///         structure
        ///     </see>
        ///     .
        ...
        ///     <br />
        ///     See
        ///     <see href="https://docs.microsoft.com/en-us/windows/win32/api/setupapi/nf-setupapi-setupdigetclassdevsw">
        ...
        /// </summary>
        /// <param name="gClass">
        ///     A pointer to the GUID for a
        ///     <see href="https://docs.microsoft.com/windows/desktop/api/setupapi/ns-setupapi-sp_devinfo_data">device setup class</see>
        ///     or a <see href="https://msdn.microsoft.com/C989D2D3-E8DE-4D64-86EE-3D3B3906390D">device interface class</see>. This
        ///     pointer is optional and can be NULL. For more information about how to set ClassGuid, see the following Remarks
        ///     section.
        /// </param>
        ...
        ///         <item>
        ///             <description>
        ///                 A PnP device instance ID.When specifying a PnP device instance ID, DIGCF_DEVICEINTERFACE must be set in
        ///                 the Flags parameter.
        ///             </description>
        ///         </item>
        ///     </list>
        ///     This pointer is optional and can be NULL.If an enumeration value is not used to select devices, set Enumerator to
        ///     NULL
        /// </param>
        /// <param name="hParent">
        ///     A handle to the top-level window to be used for a user interface that is associated with installing a device
        ///     instance in the device information set.
        ...
        ///     <see href="https://docs.microsoft.com/windows-hardware/drivers/install/device-information-sets">
        ///         device information
        ///         set
        ///     </see>
        ///     that contains all installed devices that matched the supplied parameters. If the operation fails, the
        ...
        ///     See
        ///     <see
        ///         href="https://docs.microsoft.com/en-us/windows/win32/api/setupapi/nf-setupapi-setupdigetdeviceinterfacedetailw">
        ...
        ///     DeviceInfoSet for which to retrieve details. A pointer of this type is typically returned by
        ...
        ///     The cbSize member always contains the size of the fixed part of the data structure, not a size reflecting the
        ...
        ///     The buffer must be at least (offsetof(SP_DEVICE_INTERFACE_DETAIL_DATA, DevicePath) + sizeof(TCHAR)) bytes, to
        ///     contain the fixed part of the structure and a single NULL to terminate an empty MULTI_SZ string.
        ...
        ///     If the function completed with an error, FALSE is returned and the error code for the failure can be retrieved by
        ...
        ///     <br />
        ///     See
        ///     <see href="https://docs.microsoft.com/ru-ru/windows/win32/api/setupapi/nf-setupapi-setupdienumdeviceinterfaces">
        ///         SetupDiEnumDeviceInterfaces
        ///         function
        ///     </see>
        ///     .
        /// </summary>
        /// <param name="lpDeviceInfoSet">
        ...
        /// </param>
        /// <param name="nDeviceInfoData">
        ///     A pointer to an SP_DEVINFO_DATA structure that specifies a device information element in DeviceInfoSet.
        ///     This parameter is optional and can be NULL.
        ///     If this parameter is specified, SetupDiEnumDeviceInterfaces constrains the enumeration to the interfaces that are
        ///     supported by the specified device.
        ///     If this parameter is NULL, repeated calls to SetupDiEnumDeviceInterfaces return information about the interfaces
        ...
        ///     Then, repeatedly increment MemberIndex and retrieve an interface until this function fails and GetLastError returns
        ///     ERROR_NO_MORE_ITEMS.
        /// </param>
        /// <param name="oInterfaceData">
